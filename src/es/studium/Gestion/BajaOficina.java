...
public class BajaOficina implements WindowListener, ActionListener
{
	...
	BajaOficina(){
		...
		c.rellenarChoiceBajaOficina(choOficinas);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource().equals(btnEliminar))
		{
			...
			{
				String idOficina = tabla1[0];
                c.bajaOficina(idOficina);
